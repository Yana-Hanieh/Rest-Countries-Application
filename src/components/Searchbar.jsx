...
function Searchbar({searchInput, setSearchInput, selectedRegion, setSelectedRegion, placeholder}) { //the searchbar function which takes the props from the homepage
  ...
  return (
    <div className='justify-items-center'>
        ...
        {/* Search Section */}
<form className="mt-4 border border-gray-200 dark:border-gray-700 rounded-full bg-secondary text-gray-500 dark:text-gray-200 px-2 py-4 w-full flex flex-row gap-3 items-center cursor-pointer">
